...
const PopularFaces = () => {
  return (
    <section className="max-w-5xl mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-center mb-6">POPULAR FACES</h2>
        ...
        <div className="md:col-span-2 grid grid-cols-2 gap-8">
          {popularFaces.map((person, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="w-40 h-40 rounded-full border-2 border-blue-500 flex items-center justify-center overflow-hidden">
                <img
                  src={person.image}
                  alt={person.name}
