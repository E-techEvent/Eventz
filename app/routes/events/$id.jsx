  ...
  return (
    <section>
      ...
      <div className='bg-primary mt-10 p-10 flex flex-col items-center w-full mx-auto'>
        <h3 className='mb-10 text-white'>ABOUT THIS EVENT</h3>
         <p className='text-white text-center'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi nesciunt distinctio magnam placeat doloremque explicabo repellat tempore et praesentium incidunt! Assumenda, beatae. Eveniet, ab iste! Rerum numquam quaerat libero ex!</p>
